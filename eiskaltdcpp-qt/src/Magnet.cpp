    ...
    switch (action) {
        ...
        case MAGNET_ACTION_DOWNLOAD: // download
        {
            ...
            target = path + (path.endsWith(QDir::separator())?
                                 QString("") :
                                 QDir::separator()) + target.split(QDir::separator(), WULFOR_SKIP_EMPTY).last();
...
void Magnet::download() {
    ...
    const QString &&name = path + (path.endsWith(QDir::separator()) ?
                                       QString("") :
                                       QDir::separator()) + fileName.split(QDir::separator(), WULFOR_SKIP_EMPTY).last();
...
void Magnet::slotCopyMagnet(){
    ...
    const QString name = fname.split(QDir::separator(), WULFOR_SKIP_EMPTY).last();
