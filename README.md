...
* Lists of downloaded and uploaded files (with file-type filter on finished downloads, same types as Search); ability to save logs of downloads. Finished downloads context menu can Convert to EPUB for local FB2/FBD files (writes an `.epub` beside the source and shows it in the file manager).
