...
* Lists of public and favorite hubs. Public hubs lists have multiple sources; favorite hubs are extremely flexible in configuration features. Hub reconnect uses per-day exponential backoff after disconnects; toolbar/menu Reconnect clears that backoff and connects immediately.
